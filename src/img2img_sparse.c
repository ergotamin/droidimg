...
#include <sparse/defs.h>
#include <sparse/sparse_file.h>
#include <sparse/output_file.h>
#include <sparse/backed_block.h>
#include <sparse/sparse_defs.h>
...
struct chunk_data {
    ...
    int				(*write)(void *priv, const void *data, int len, unsigned int block, unsigned int nr_blocks);
};
