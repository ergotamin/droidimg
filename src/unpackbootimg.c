...
int unpackbootimg(int argc, char **argv)
{
    char tmp[PATH_MAX];
    char *directory = "./";
    char *filename = NULL;
    ...
    unsigned int hdr_ver_max = 4;   /* arbitrary maximum header version value; when greater assume the field is appended dtb size */
